...
exports.createOrder = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const courseExistsInUser = user === null || user === void 0 ? void 0 : user.courses.some((course) => course._id.toString() === courseId); //take care if this user is logged in before purchasing
